...
fn main() {
    ...
    Builder::new()
        .with_lang("rust-jsonrpc")
        .compile(&["./api/city_jsonrpc_stream.idl"])
        .expect("failed to compile city jsonrpc stream idl for rust-jsonrpc example");
    ...
    Builder::new()
        .with_lang("openrpc")
        .with_out_dir("./api")
        .with_output_filename("city_jsonrpc_stream_openrpc.json")
        .compile(&["./api/city_jsonrpc_stream.idl"])
