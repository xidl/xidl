// Code generated by xidlc-v0.91.1-522ca4e9. DO NOT EDIT.
...
pub mod DDS {
    ...
    pub mod XTypes {
        ...
        impl TypeIdentifier {
            ...
            #[allow(clippy::borrowed_box)]
            pub fn as_sc_component_id_mut(
                &mut self,
            ) -> &mut StronglyConnectedComponentId {
                debug_assert!(self.is_sc_component_id());
        ...
        impl Default for TypeIdentifier {
            fn default() -> Self {
                Self {
                    tag: u8::default(),
                    data: TypeIdentifierData {
                        extended_defn: core::mem::ManuallyDrop::new(
                            ExtendedTypeDefn::default(),
                        ),
                    },
                }
            }
        ...
        impl serde::Serialize for TypeIdentifier {
                ...
                __S: serde::Serializer,
            {
                let helper = if matches!(
                    self.tag, TI_STRING8_SMALL | TI_STRING16_SMALL
                ) {
                    let tag = match self.tag {
                    ...
                    TypeIdentifierSerdeRef {
                        tag,
                        data: TypeIdentifierSerdeRefData::Case8(
                            self.as_sc_component_id(),
                        ),
                    }
                } else if matches!(self.tag, EK_COMPLETE | EK_MINIMAL) {
                    let tag = match self.tag {
                    ...
                    TypeIdentifierSerdeRef {
                        tag,
                        data: TypeIdentifierSerdeRefData::Case9(
                            self.as_equivalence_hash(),
                        ),
                    }
                } else {
                    let tag = "default";
        ...
        impl AnnotationParameterValue {
            ...
            #[allow(clippy::borrowed_box)]
            pub fn as_extended_value_mut(
                &mut self,
            ) -> &mut ExtendedAnnotationParameterValue {
                debug_assert!(self.is_extended_value());
                ...
                __S: serde::Serializer,
            {
                let helper = if matches!(self.tag, TK_BOOLEAN) {
                    ...
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case0(
                            self.as_boolean_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_BYTE) {
                    let tag = "TK_BYTE";
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case1(
                            self.as_byte_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_INT16) {
                    ...
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case2(
                            self.as_int16_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_UINT16) {
                    ...
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case3(
                            self.as_uint_16_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_INT32) {
                    let tag = "TK_INT32";
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case4(
                            self.as_int32_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_UINT32) {
                    ...
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case5(
                            self.as_uint32_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_INT64) {
                    let tag = "TK_INT64";
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case6(
                            self.as_int64_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_UINT64) {
                    ...
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case7(
                            self.as_uint64_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_FLOAT32) {
                    let tag = "TK_FLOAT32";
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case8(
                            self.as_float32_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_FLOAT64) {
                    let tag = "TK_FLOAT64";
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case9(
                            self.as_float64_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_FLOAT128) {
                    let tag = "TK_FLOAT128";
                    ...
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case11(
                            self.as_char_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_CHAR16) {
                    ...
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case12(
                            self.as_wchar_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_ENUM) {
                    ...
                    AnnotationParameterValueSerdeRef {
                        tag,
                        data: AnnotationParameterValueSerdeRefData::Case14(
                            self.as_string8_value(),
                        ),
                    }
                } else if matches!(self.tag, TK_STRING16) {
                    let tag = "TK_STRING16";
        ...
        impl<'de> serde::Deserialize<'de> for AnnotationParameterValue {
            ...
            where
                D: serde::Deserializer<'de>,
            {
                let helper = AnnotationParameterValueSerdeOwned::deserialize(
                    deserializer,
                )?;
                match helper.tag.as_str() {
                    "TK_BOOLEAN" => {
        ...
        impl Default for CompleteTypeObject {
            fn default() -> Self {
                Self {
                    tag: u8::default(),
                    data: CompleteTypeObjectData {
                        extended_type: core::mem::ManuallyDrop::new(
                            CompleteExtendedType::default(),
                        ),
                    },
                }
            }
        ...
        impl serde::Serialize for CompleteTypeObject {
                ...
                __S: serde::Serializer,
            {
                let helper = if matches!(self.tag, TK_ALIAS) {
                    ...
                    CompleteTypeObjectSerdeRef {
                        tag,
                        data: CompleteTypeObjectSerdeRefData::Case1(
                            self.as_annotation_type(),
                        ),
                    }
                } else if matches!(self.tag, TK_STRUCTURE) {
                    ...
                    CompleteTypeObjectSerdeRef {
                        tag,
                        data: CompleteTypeObjectSerdeRefData::Case2(
                            self.as_struct_type(),
                        ),
                    }
                } else if matches!(self.tag, TK_UNION) {
                    ...
                    CompleteTypeObjectSerdeRef {
                        tag,
                        data: CompleteTypeObjectSerdeRefData::Case4(
                            self.as_bitset_type(),
                        ),
                    }
                } else if matches!(self.tag, TK_SEQUENCE) {
                    ...
                    CompleteTypeObjectSerdeRef {
                        tag,
                        data: CompleteTypeObjectSerdeRefData::Case5(
                            self.as_sequence_type(),
                        ),
                    }
                } else if matches!(self.tag, TK_ARRAY) {
                    let tag = "TK_ARRAY";
                    ...
                    CompleteTypeObjectSerdeRef {
                        tag,
                        data: CompleteTypeObjectSerdeRefData::Case8(
                            self.as_enumerated_type(),
                        ),
                    }
                } else if matches!(self.tag, TK_BITMASK) {
                    let tag = "TK_BITMASK";
                    CompleteTypeObjectSerdeRef {
                        tag,
                        data: CompleteTypeObjectSerdeRefData::Case9(
                            self.as_bitmask_type(),
                        ),
                    }
                } else {
                    let tag = "default";
                    CompleteTypeObjectSerdeRef {
                        tag,
                        data: CompleteTypeObjectSerdeRefData::Case10(
                            self.as_extended_type(),
                        ),
                    }
                };
                helper.serialize(__serializer)
        ...
        impl serde::Serialize for MinimalTypeObject {
                ...
                __S: serde::Serializer,
            {
                let helper = if matches!(self.tag, TK_ALIAS) {
                    ...
                    MinimalTypeObjectSerdeRef {
                        tag,
                        data: MinimalTypeObjectSerdeRefData::Case1(
                            self.as_annotation_type(),
                        ),
                    }
                } else if matches!(self.tag, TK_STRUCTURE) {
                    ...
                    MinimalTypeObjectSerdeRef {
                        tag,
                        data: MinimalTypeObjectSerdeRefData::Case5(
                            self.as_sequence_type(),
                        ),
                    }
                } else if matches!(self.tag, TK_ARRAY) {
                    ...
                    MinimalTypeObjectSerdeRef {
                        tag,
                        data: MinimalTypeObjectSerdeRefData::Case8(
                            self.as_enumerated_type(),
                        ),
                    }
                } else if matches!(self.tag, TK_BITMASK) {
                    ...
                    MinimalTypeObjectSerdeRef {
                        tag,
                        data: MinimalTypeObjectSerdeRefData::Case9(
                            self.as_bitmask_type(),
                        ),
                    }
                } else {
                    ...
                    MinimalTypeObjectSerdeRef {
                        tag,
                        data: MinimalTypeObjectSerdeRefData::Case10(
                            self.as_extended_type(),
                        ),
                    }
                };
        ...
        impl Default for TypeObject {
            fn default() -> Self {
                Self {
                    tag: EK_COMPLETE,
                    data: TypeObjectData {
                        complete: core::mem::ManuallyDrop::new(
                            CompleteTypeObject::default(),
                        ),
                    },
                }
            }
                ...
                match helper.tag.as_str() {
                    ...
                    _ => {
                        Err(
                            serde::de::Error::custom(
                                format!(
                                    "union TypeObject tag/data mismatch for tag `{}`", helper
                                    .tag
                                ),
                            ),
                        )
