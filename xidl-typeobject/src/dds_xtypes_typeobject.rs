...
pub struct TypeIdentfierWithSize {
...
pub type TypeIdentfierWithSizeSeq = Vec<TypeIdentfierWithSize>;
pub struct TypeIdentifierWithDependencies {


    pub typeid_with_size: Box<TypeIdentfierWithSize>,

    pub dependent_typeid_count: i32,

    pub dependent_typeids: Vec<TypeIdentfierWithSize>,
