...
def _http_security_service_get_user_route(service: HttpSecurityServiceService) -> Route:
    ...
    return Route(
        ...
        metadata=RouteMetadata(request_content_type="", response_content_type="text/plain", security=[SecurityRequirement(kind="basic", realm=None), SecurityRequirement(kind="api_key", location="header", name="X-API-Key"), ], stream=None),
    )
...
def _http_security_service_health_route(service: HttpSecurityServiceService) -> Route:
    ...
    return Route(
        ...
        metadata=RouteMetadata(request_content_type="", response_content_type="text/plain", security=[], stream=None),
    )
