...
pub(super) fn validate_header_name(bound_name: &str, param_name: &str) -> HttpHirResult<()> {
...
pub(super) fn validate_cookie_name(bound_name: &str, param_name: &str) -> HttpHirResult<()> {
    if bound_name.is_empty() {
