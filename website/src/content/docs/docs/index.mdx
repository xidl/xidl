...
This page introduces the core elements of the XIDL language: basic and
container types, structs, enums, interfaces, and unions.
...
See [Annotations](./annotations/) for the full built-in annotation reference,
and [Compiler Pragmas](./pragmas/) for compiler-level directives.
