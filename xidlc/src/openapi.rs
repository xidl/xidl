...
builder! {
    ...
    /// ```rust
    /// # use xidlc::openapi::{Info, Paths, Components, OpenApiBuilder};
...
impl OpenApi {
    ...
    ///
    /// ```rust
    /// # use xidlc::openapi::{Info, Paths, OpenApi};
    /// #
    ...
    /// ```rust
    ///  # use xidlc::openapi::{OpenApi, OpenApiBuilder};
    ///  # use xidlc::openapi::path::{PathsBuilder, PathItemBuilder, PathItem,
...
impl OpenApiBuilder {
    ...
    /// ```rust
    /// # use xidlc::openapi::OpenApiBuilder;
