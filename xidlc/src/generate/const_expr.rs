...
fn render_xor<FScoped, FLit>(expr: &hir::XorExpr, scoped_name: &FScoped, literal: &FLit) -> String
where
    FScoped: Fn(&hir::ScopedName) -> String,
    FLit: Fn(&hir::Literal) -> String,
{
...
fn render_and<FScoped, FLit>(expr: &hir::AndExpr, scoped_name: &FScoped, literal: &FLit) -> String
where
    FScoped: Fn(&hir::ScopedName) -> String,
    FLit: Fn(&hir::Literal) -> String,
{
...
fn render_add<FScoped, FLit>(expr: &hir::AddExpr, scoped_name: &FScoped, literal: &FLit) -> String
where
    FScoped: Fn(&hir::ScopedName) -> String,
    FLit: Fn(&hir::Literal) -> String,
{
...
fn render_mult<FScoped, FLit>(expr: &hir::MultExpr, scoped_name: &FScoped, literal: &FLit) -> String
where
    FScoped: Fn(&hir::ScopedName) -> String,
    FLit: Fn(&hir::Literal) -> String,
{
