...
pub fn generate(
    ...
    let output = spec::render_spec(&spec, file_name, &renderer, &rest_hir)?;
...
pub(crate) struct TypescriptRestCodegen;

#[async_trait::async_trait]
impl crate::jsonrpc::Codegen for TypescriptRestCodegen {
