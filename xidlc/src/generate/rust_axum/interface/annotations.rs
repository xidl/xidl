...
pub fn field_rename_raw(annotations: &[hir::Annotation]) -> Option<String> {
...
pub fn field_rename(annotations: &[hir::Annotation], rust_name: &str) -> Option<String> {
    field_rename_raw(annotations).and_then(|value| serde_rename(&value, rust_name))
}

pub fn has_flatten_annotation(annotations: &[hir::Annotation]) -> bool {
...
pub fn normalize_params(params: &hir::AnnotationParams) -> HashMap<String, String> {
...
pub fn parse_raw_params(raw: &str) -> Vec<(String, String)> {
...
pub fn unescape_param_value(value: &str) -> String {
...
pub fn trim_quotes(value: &str) -> Option<String> {
...
pub fn render_const_expr(expr: &hir::ConstExpr) -> String {
...
pub fn serde_rename(raw: &str, rust: &str) -> Option<String> {
