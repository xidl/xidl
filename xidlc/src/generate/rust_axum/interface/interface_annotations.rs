...
pub(crate) fn field_rename_raw(annotations: &[hir::Annotation]) -> Option<String> {
...
pub(crate) fn field_rename(annotations: &[hir::Annotation], rust_name: &str) -> Option<String> {
    field_rename_raw(annotations).and_then(|value| serde_rename(&value, rust_name))
}

pub(crate) fn has_flatten_annotation(annotations: &[hir::Annotation]) -> bool {
...
pub(crate) fn serde_rename(raw: &str, rust: &str) -> Option<String> {
