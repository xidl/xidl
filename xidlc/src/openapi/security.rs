...
/// to execute the operation. They can be defined in [`#[xidlc::path(...)]`][path] or in `#[openapi(...)]`
/// of [`OpenApi`][openapi].
///
/// Applying the security requirement to [`OpenApi`][openapi] will make it globally
/// available to all operations. When applied to specific [`#[xidlc::path(...)]`][path] will only
...
impl SecurityRequirement {
    ...
    /// ```rust
    /// # use xidlc::openapi::security::SecurityRequirement;
...
/// ```rust
/// # use xidlc::openapi::security::{SecurityScheme, OAuth2, Implicit, Flow, Scopes};
...
/// ```rust
/// # use xidlc::openapi::security::{SecurityScheme, HttpAuthScheme, HttpBuilder};
/// SecurityScheme::Http(
...
impl ApiKeyValue {
    ...
    /// ```rust
    /// # use xidlc::openapi::security::ApiKeyValue;
...
impl Http {
    ...
    /// ```rust
    /// # use xidlc::openapi::security::{SecurityScheme, Http, HttpAuthScheme};
...
impl HttpBuilder {
    ...
    /// ```rust
    /// # use xidlc::openapi::security::{HttpBuilder, HttpAuthScheme};
...
impl OpenIdConnect {
    ...
    ///
    /// ```rust
    /// # use xidlc::openapi::security::OpenIdConnect;
...
impl OAuth2 {
    ...
    /// ```rust
    /// # use xidlc::openapi::security::{OAuth2, Flow, Password, AuthorizationCode, Scopes};
...
impl Implicit {
    ...
    /// ```rust
    /// # use xidlc::openapi::security::{Implicit, Scopes};
    /// Implicit::new(
    ///     "https://localhost/auth/dialog",
    ///     Scopes::from_iter([
    ///         ("edit:items", "edit my items"),
...
impl AuthorizationCode {
    ...
    /// ```rust
    /// # use xidlc::openapi::security::{AuthorizationCode, Scopes};
    /// AuthorizationCode::new(
    ///     "https://localhost/auth/dialog",
...
impl Password {
    ...
    /// ```rust
    /// # use xidlc::openapi::security::{Password, Scopes};
    /// Password::new(
    ///     "https://localhost/token",
    ///     Scopes::from_iter([
    ///         ("edit:items", "edit my items"),
...
impl ClientCredentials {
    ...
    /// ```rust
    /// # use xidlc::openapi::security::{ClientCredentials, Scopes};
...
/// ```rust
/// # use xidlc::openapi::security::Scopes;
