...
use super::{
    Deprecated, ExternalDocs, RefOr, Required, Schema, Server, builder,
...
impl Paths {
    ...
    /// ```rust
    /// # use xidlc::openapi::path::{Paths, HttpMethod};
    /// # let paths = Paths::new();
...
impl PathsBuilder {
    ...
    /// ```rust
    /// # struct MyPath;
    /// # impl xidlc::Path for MyPath {
    /// #   fn methods() -> Vec<xidlc::openapi::path::HttpMethod> { vec![] }
    /// #   fn path() -> String { String::new() }
    /// #   fn operation() -> xidlc::openapi::path::Operation {
    /// #        xidlc::openapi::path::Operation::new()
    /// #   }
    /// # }
    /// let paths = xidlc::openapi::path::PathsBuilder::new();
...
builder! {
    ...
    pub struct Operation {
        ...
        ///
        /// When used with derive [`#[xidlc::path(...)]`][derive_path] attribute macro the default
        ...
        ///
        /// When used with derive [`#[xidlc::path(...)]`][derive_path] attribute macro the value
        ...
        ///
        /// When used with derive [`#[xidlc::path(...)]`][derive_path] attribute macro the
        ...
        ///
        /// When used with derive [`#[xidlc::path(...)]`][derive_path] attribute macro the handler function
