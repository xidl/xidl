...
use super::{Deprecated, Response, builder, security::SecurityScheme, set_value, xml::Xml};
...
impl ComponentsBuilder {
    ...
    /// # Examples
    /// ```rust
    /// # use xidlc::openapi::schema::{ComponentsBuilder, ObjectBuilder,
    /// #    Type, Schema};
...
impl Discriminator {
    ...
    /// ```rust
    /// # use xidlc::openapi::schema::Discriminator;
...
impl OneOf {
    ...
    /// ```rust
    /// # use xidlc::openapi::schema::OneOf;
...
impl AllOf {
    ...
    /// ```rust
    /// # use xidlc::openapi::schema::AllOf;
...
impl AnyOf {
    ...
    /// ```rust
    /// # use xidlc::openapi::schema::AnyOf;
...
builder! {
    ...
    pub struct Object {
        ...
        pub multiple_of: Option<crate::openapi::Number>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", serialize_with = "omit_decimal_zero")]
        pub maximum: Option<crate::openapi::Number>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", serialize_with = "omit_decimal_zero")]
        pub minimum: Option<crate::openapi::Number>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", serialize_with = "omit_decimal_zero")]
        pub exclusive_maximum: Option<crate::openapi::Number>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", serialize_with = "omit_decimal_zero")]
        pub exclusive_minimum: Option<crate::openapi::Number>,
...
impl Object {
    ...
    /// ```rust
    /// # use xidlc::openapi::schema::{Object, Type};
...
impl ObjectBuilder {
    ...
    pub fn multiple_of<N: Into<crate::openapi::Number>>(mut self, multiple_of: Option<N>) -> Self {
    ...
    pub fn exclusive_minimum<N: Into<crate::openapi::Number>>(
        mut self,
...
fn omit_decimal_zero<S>(
    maybe_value: &Option<crate::openapi::Number>,
    serializer: S,
) -> Result<S::Ok, S::Error>
where
    S: serde::Serializer,
{
    match maybe_value {
        Some(crate::openapi::Number::Float(float)) => {
        ...
        Some(crate::openapi::Number::Int(int)) => serializer.serialize_i64(*int as i64),
        Some(crate::openapi::Number::UInt(uint)) => serializer.serialize_u64(*uint as u64),
...
impl Array {
    ...
    /// ```rust
    /// # use xidlc::openapi::schema::{Schema, Array, Type, Object};
...
impl ArrayBuilder {
    ...
    /// ```rust
    /// # use xidlc::openapi::schema::{ArrayBuilder, SchemaType, Type, Object};
...
impl SchemaType {
    ...
    /// ```rust
    /// # use xidlc::openapi::schema::{SchemaType, Type};
