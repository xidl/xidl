...
impl PlainCdrSerialize {
    ...
    where
        T: ToNeBytes<N>,
    {
        write_aligned::<Align8, T, N>(self.buf, self.len, &mut self.pos, self.do_io, val, false)
    }
}

impl XcdrSerializer for PlainCdrSerialize {
