...
impl<'a> Plcdr2Deserializer<'a> {
    ...
    pub fn read_dheader(&mut self) -> crate::error::XcdrResult<u32> {
        self.read_u32_ne()
    }

    pub fn read_emheader(&mut self) -> crate::error::XcdrResult<u32> {
        self.read_u32_ne()
    }
...
impl XcdrDeserializer for Plcdr2Deserializer<'_> {
